...
//            int cropHeight = originalImage.getHeight(); // Высота остается неизменной
            ...
            // Выполняем обрезку
            BufferedImage croppedImage = originalImage.getSubimage(cropStartX+201, cropStartY+3, 95, originalImage.getHeight()-4);

            // Сохраняем обрезанное изображение
            File outputFile = new File("C:\\Users\\Aliaksandr_Kreyer\\Desktop\\my\\PokerScreen\\src\\main\\resources\\cards\\8_diamonds.png");
